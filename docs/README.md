...
- latest LongLive2 SP status: local plumbing is implemented and no-cost validated; no paid GPU render has been launched yet. Use `longlive2plan.md` plus `docs/video-longlive2-sp-streaming.md` before launching a two-GPU one-stream test.
