...
- latest Scope/LongLive matrix snapshot: `H200 x1` passed `320x576` at `25.376 fps`; `368x640`, `480x832`, and `RTX 4090 256x448` failed realtime. Run root: `/Users/xenochain/Downloads/scope_longlive_vast_matrix_20260520T200307Z/`.
